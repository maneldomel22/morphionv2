...
export default function InfluencerCard({ influencer, onSelect, index = 0 }) {
  return (
    <button
      onClick={onSelect}
      className="group bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-lg transition-all duration-300 overflow-hidden animate-fade-in-up"
